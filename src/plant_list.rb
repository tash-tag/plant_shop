...
def initialize
 ...
 {:size => "medium", :care => "challenging", :light => "high", :plant_name => "Nephrolepis exelata / Boston fern", :price => "$25"},
 {:size => "large", :care => "easy", :light => "low", :plant_name => "Howea forsteriana / Kentia Palm", :price => "$55"},
